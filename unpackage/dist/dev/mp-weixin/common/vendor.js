...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"uniapp-wx-customModal","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!************************************************************************!*\
  !*** D:/AllProjects/HBuilderProjects/uniapp-wx-customModal/pages.json ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
var modal = {
  ...
  mutations: {
    SUCCESS: function SUCCESS(state, type) {
      var obj = {
        cancel: false,
        confirm: false
      };
    ...
    SHOW_MODAL: function SHOW_MODAL(state, options) {
      state = Object.assign(state, options);
      state.visible = true;
    },
    HIDE_MODAL: function HIDE_MODAL(state) {
      state.visible = false;
    }
  },
  actions: {
    Success: function Success(_ref, type) {
      var commit = _ref.commit;
      commit('SUCCESS', type);
    },
    ShowMoadl: function ShowMoadl(_ref2, options) {
      var commit = _ref2.commit;
      commit('SHOW_MODAL', options);
    },
    HideModal: function HideModal(_ref3, payload) {
...
exports.modal = modal;
var showModal = function showModal(options) {
  if ((0, _typeof2.default)(options) === 'object') {
    _store.default.dispatch('ShowMoadl', options);
  } else {
    throw new Error("\u914D\u7F6E\u9879\u5FC5\u987B\u4E3A\u5BF9\u8C61,\u4F20\u5165\u4E3A:".concat((0, _typeof2.default)(options)));
  }
};
